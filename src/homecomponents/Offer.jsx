...
import lighthouse from "../assets/offerimage.jpg";
import { BiWorld } from "react-icons/bi";
import { BsHeadphones, BsPerson } from "react-icons/bs";
export default function Offer() {
  const data = [
    {
      text: "Personalized Trip Plans Tailored for You",
      icon: <BsPerson />,
      color: "red",
    },
    {
    ...
    {
      text: "Explore Incredible India with Smart Guidance",
      icon: <BsHeadphones />,
      color: "yellow",
    },
  ];
  return (
    <Section id="offer">
      ...
      <div className="content">
        <div className="title">
          <h1>We are Offering 200+ Stunning Destinations Across India</h1>
        </div>
        <ul className="list">
